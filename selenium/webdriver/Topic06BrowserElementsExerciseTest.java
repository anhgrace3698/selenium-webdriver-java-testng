...
public class Topic06BrowserElementsExerciseTest {
    WebDriver driver;
    @BeforeClass
...
//Browser
    ...
    public void TC04_getPageSourceCode(){
        ...
        System.out.println(driver.getPageSource().contains("Login or Create an Account"));// expect true

        // get page source, compare text in account page
        driver.findElement(By.xpath("//span[text()='Create an Account']")).click();
        System.out.println(driver.getPageSource().contains("Create an Account"));// exxpect true
    }
